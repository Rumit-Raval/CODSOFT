...
#frames
frame_up = Frame(window, width=500, height=50, bg=co1)
frame_up.grid(row=0, column=0, padx=0, pady=0)

frame_down = Frame(window, width=500, height=160, bg=co2)
frame_down.grid(row=1, column=0, padx=0, pady=0) 

frame_table = Frame(window, width=500, height=100, bg=co4, relief="flat")
frame_table.grid(row=2, column=0, columnspan=2, padx=10, pady=0, sticky=NW)
...
def to_update():
    try:
        ...
        def confirm():
            ...
            show()
        b_confirm = Button(frame_down, text="Confirm", width=10, height=1, bg=co2, fg=co1, font=('Ivy 8 bold'), command=confirm)
...
#frame_up widgets
app_name = Label(frame_up, text="ContactBook", height = 1, font = ('verdana 17 bold'), bg= co1 , fg = co2)
app_name.place(x=5, y=5)

#frame_down widgets
l_name = Label(frame_down, text="Name ", width=20, height = 1, font = ('Ivy 15'), bg= co2,fg = co1, anchor=NW)
l_name.place(x=10, y=20)
e_name = Entry(frame_down, width=25, justify='left', highlightthickness=1, relief='solid')
e_name.place(x=115, y=20)

l_gender = Label(frame_down, text="Gender", width=20, height = 1, font = ('Ivy 15'), bg= co2,fg = co1, anchor=NW)
l_gender.place(x=10, y=45)
c_gender = ttk.Combobox(frame_down, width= 22)
c_gender['values'] = ['Male', 'Female', 'Transgender']
c_gender.place(x=115, y=50)

l_telephone = Label(frame_down, text="Telephone ", height = 1, font = ('Ivy 15'), bg= co2,fg = co1, anchor=NW)
l_telephone.place(x=10, y=80)
e_telephone = Entry(frame_down, width=25, justify='left', highlightthickness=1, relief='solid')
e_telephone.place(x=115, y=84)

l_email = Label(frame_down, text="Email", height = 1, font = ('Ivy 15'), bg= co2,fg = co1, anchor=NW)
l_email.place(x=10, y=110)
e_email = Entry(frame_down, width=25, justify='left', highlightthickness=1, relief='solid')
e_email.place(x=115, y=115)
...
b_delete = Button(frame_down, text="Delete", width=10,  height=1, bg=co2, fg=co1, font=('Ivy 8 bold'), command=to_remove)
